...
SCENE_ADAPTATION = {"scene_id":"symptom_table","field_patterns":{},"hints":[],"constraints":[],"validation_rules":[],"fallback_policy":"ask_user_confirm_mapping"}
...
def parse_lines(
    ...
    for raw_line in lines:
        ...
        numbered = re.match(r"^\s*(?:step\s*)?(\d+)[.)銆乚\s*(.+)$", line, flags=re.IGNORECASE)
        if numbered:
            record = {field: "" for field in fields}
